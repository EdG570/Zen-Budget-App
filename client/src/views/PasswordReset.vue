            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <form @submit.prevent="validateForm" class="login-form">
                        ...
                        <div class="form-group">
                            <span class="error-msg" v-if="!this.bothPasswordsMatch">Password must match</span>
...
export default {
    ...
    methods: {
        ...
        passwordsMatch() {
            if (this.password == this.passwordConfirm) this.bothPasswordsMatch = true
            else this.bothPasswordsMatch = false
        },
        saveNewPassword() {
            const formBody = {
              email: this.email,
            ...
            this.resetEmailPassword(formBody)
            this.resetForm()
        ...
        validateForm() {
            ...
            if (this.emailIsValid && this.passwordIsValid && this.bothPasswordsMatch) {
