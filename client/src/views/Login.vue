            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <form @submit.prevent="validateForm" class="login-form">
                        ...
                        <span class="register-msg">New here? <router-link to="/register" class="register-link">Sign up</router-link></span>
                        <span class="forgot-pw" data-toggle="modal" data-target="#exampleModal">Forget your password?</span>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                <p id="body-title">Enter your email below to receive a password reset link:</p>
                                <form>
                                    <div class="form-group">
                                        <input v-model="emailReset" 
                                            type="email" 
                                            class="form-control" 
                                            placeholder="Email"
                                        >
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" @click="sendReset" data-dismiss="modal">Send</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        logInUser() {
            ...
            this.authenticateUser(formBody)
            this.resetForm()
        ...
        sendReset() {
            const body = { email: this.emailReset }
            this.sendPasswordResetEmail(body)
        }
    }
}
</script>
