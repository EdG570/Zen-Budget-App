<template>
    <div class="modal fade" id="newVariableExpenseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
  ...
  methods: {
      createExpense() {
          ...
          this.$emit('newVariableExpenseReady', expense)
      },
      validateName() {
